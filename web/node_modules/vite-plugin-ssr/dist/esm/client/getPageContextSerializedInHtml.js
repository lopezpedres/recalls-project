...
function getPageContextSerializedInHtml() {
    assertUsage('__vite_plugin_ssr__pageContext' in window, 'Client-side `pageContext` missing. Make sure to apply `injectAssets()` to the HTML strings you generate, see https://vite-plugin-ssr.com/injectAssets');
    const pageContext = {};
