...
function plugin() {
    const plugins = [(0, dev_1.dev)(), (0, build_1.build)(), (0, manifest_1.manifest)(), (0, vite_plugin_import_build_1.importBuild)((0, getImportBuildCode_1.getImportBuildCode)()), (0, packageJsonFile_1.packageJsonFile)()];
    return plugins;
}
